      ...
      if (token) {
        try {
          ...
          if (response.ok) {
            ...
            setAddress(data.userDetails.accountAddress);
          } else {
        ...
        <div className="w-1/2 flex flex-col items-center justify-center border border-gray-700 rounded-lg p-6">
          ...
          {songCID && (
            <div className="mt-4 flex flex-col items-center">
              <h2 className="text-xl font-bold text-white mb-2">Uploaded Song</h2>
              <audio controls className="mt-2">
                <source src={`https://emerald-persistent-platypus-879.mypinata.cloud/ipfs/${songCID}`} type="audio/mpeg" />
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full border bg-[#232328] text-white border-gray-600 rounded-md shadow-sm p-2"
              />
            </div>
            <div>
              ...
              {thumbnailCID && (
                <div className="mt-4">
                  ...
                  <img src={`https://emerald-persistent-platypus-879.mypinata.cloud/ipfs/${thumbnailCID}`} alt="Thumbnail" className="mt-2 rounded-lg" />
                </div>
              )}
            </div>
            <button
