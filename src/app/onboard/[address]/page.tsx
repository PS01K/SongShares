...
export default function OnboardingPage({ params }: { params: { address: string } }) {
  ...
  return (
    <div className="min-h-screen bg-[#18181a] flex justify-center items-center p-6 text-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="block w-full px-3 py-2 border bg-[#27282d] border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-[#5b5bd5] focus:border-[#5b5bd5] text-white"
              required
            />
          </div>
