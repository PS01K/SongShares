...
const OwnerTokenCard = (props: Props) => {
    ...
    return (
        <div className="w-80 h-[450px] rounded-lg flex flex-col overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 relative group">
            ...
            {isReleased ? <button className="w-full text-center py-2 bg-green-700 font-semibold text-lg text-white">
                Released
            </button> : <button className="w-full text-center py-2 bg-[#5b5bd5] font-semibold text-lg cursor-pointer text-white" onClick={handleRelease}>
                Release
            </button>
            }
        </div>
