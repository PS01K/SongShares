    ...
    <div className='w-full flex items-center justify-between px-20 py-12 bg-[#18181a]'>
      <div className='flex justify-center gap-6'>
        ...
        <div className='flex flex-col justify-center'>
          ...
          <p className='opacity-60 text-white'>{user.accountAddress.substr(0, 6) + "..." + user.accountAddress.substr(user.accountAddress.length - 3, user.accountAddress.length - 1)}</p>
        </div>
      </div>
      <div className='flex items-center gap-6'>
        <div className='flex flex-col justify-center'>
          {/* <p>Complete your Profile</p> */}
          <button onClick={handleOnboard} className='text-center text-white bg-[#5b5bd5] px-4 py-2 rounded-xl'>OnBoard Now</button>
        </div>
